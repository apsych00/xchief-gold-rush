...
const dict = {
  en: {
    ...
    profile: {
      ...
      shareTextShort: 'My record in the xChief Gold Rush: {record} coins. Can you beat it? {url}',
      foot: 'Progress is saved on this device.',
    },
    share: {
      title: 'xChief Gold Rush record',
      cardTitle: 'My Gold Rush record',
      record: '{record} coins',
      rank: 'Rank {rank} · {tier}',
      copy: 'Copy',
      copied: 'Link copied',
      ...
      close: 'Close',
      play: 'Play Gold Rush',
      joinTournament: 'Join {title}',
      notAvailable: 'This record is not available',
      error: 'Something went wrong. Try again',
      rateLimited: 'Too fast. Wait a second',
      ogTitleDefault: 'xChief Gold Rush record',
      ogTitle: "{display}'s xChief Gold Rush record: {record} coins",
      ogDescriptionDefault: 'Play the xChief Gold Rush challenge and beat this record.',
      ogDescription: "{display}'s record in the xChief Gold Rush: {record} coins. Can you beat it?",
    },
    tasks: {
      title: 'Missions',
      ...
      instagramHandleSub: 'Enter your handle, then follow @xchief to earn the reward',
      instagramHandlePlaceholder: 'yourhandle',
      instagramFollowCta: 'Follow @xchief',
      instagramFollowTitle: 'Follow @xchief',
      instagramFollowSub: 'Follow @xchief on Instagram, then come back and tap Check.',
      instagramOpenAgain: 'Open Instagram',
      instagramCheckCta: 'I followed, check',
      instagramChecking: 'Checking…',
      instagramNotFollowing: 'We could not see the follow yet. Follow @xchief and tap check again.',
      ...
      items: {
        ...
        youtube_1: { title: 'Watch xChief video 1', desc: 'Under a minute' },
        youtube_2: { title: 'Watch xChief video 2', desc: 'Under a minute' },
        youtube_3: { title: 'Watch xChief video 3', desc: 'Under a minute' },
