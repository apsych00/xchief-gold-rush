  ...
  fa: {
    ...
    tasks: {
      ...
      items: {
        ...
        signup: { title: 'حساب xChief بساز', desc: 'بزرگ‌ترین جایزه · نام، ایمیل، موبایل' },
      },
    },
    lead: {
    ...
    signup: {
      ...
      cta: '{n}+ سکه بگیر',
      notNow: 'حالا نه',
      errName: 'نامت رو وارد کن',
      errEmail: 'یک ایمیل معتبر وارد کن',
      errPhone: 'یک شمارهٔ معتبر وارد کن',
  ...
  en: {
    ...
    tasks: {
      ...
      items: {
        ...
        signup: { title: 'Open an xChief account', desc: 'Biggest reward · name, email, phone' },
      },
    },
    lead: {
